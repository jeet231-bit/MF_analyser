    ...
    return {
        ...
        "insights": [
            ...
            {"key": "corpus_at_risk", "section": "cost", "eyebrow": "Investor impact", "title": "Corpus in the bottom half",
             ...
             "sentence": {"default": "{sum} sits in {count|fund|funds} ranked Q3 or Q4.", "one": "{sum} sits in the one fund ranked Q3 or Q4.", "zero": "No fund sits in Q3 or Q4.", "trigger": "count"}},
        ...
        "narratives": {
            ...
            "categories": [{"default": "{categories|category|categories}, {unranked} unranked.", "zero": "{categories|category|categories}, none unranked.", "trigger": "unranked"},
                           {"default": "Among the {eligible} categories with {min_group} or more rated funds, {widest.label} has the widest spread ({widest.value})."}],
            "executive": [{"default": "{rated|fund carries|funds carry} a composite rating this cycle across {ranked_categories} ranked {ranked_categories?category|categories}.", "requires": ["ranked_categories"]},
                          {"default": "{rated|fund carries|funds carry} a composite rating this cycle, but {rated?its category has|their categories have} fewer than {unranked_below} ranked funds.", "requires": ["rated"], "unless": ["ranked_categories"]},
                          {"default": "{q1} of them {q1?sits|sit} in the top quartile.", "zero": "None of them sits in the top quartile.", "requires": ["rated", "ranked_categories"]},
                          {"default": "{total|fund is|funds are} in scope and none carries a composite rating.", "unless": ["rated"]},
                          {"default": "{unrated_gap|fund is|funds are} a data gap.", "unless": ["rated"]},
                          {"default": "{ins.amc_league.group.label} holds the most Q1 funds ({ins.amc_league.group.count} of {ins.amc_league.group.total} rated).", "trigger": "ins.amc_league.group.count"},
                          {"default": "{moved|fund|funds} changed rank since {previous}.", "zero": "No fund changed rank since {previous}.", "requires": ["rated"]}],
            "distribution": [{"default": "Quartiles are computed within each category: {ranked_categories} ranked categories.", "one": "One ranked category: its own quartiles."}],
            "coverage": [{"default": "{rated} of {total} funds in the master carry a composite rating."},
                         {"default": "{unrated_gap|fund is|funds are} a data gap."}],
        ...
        "kpis": [{"label": "Rated funds", "value": "{rated}", "note": "across {ranked_categories} ranked {ranked_categories?category|categories}", "tone": "q1"},
                 {"label": "Top quartile", "value": "{q1}", "note": "{q1_pct} of rated funds", "tone": "accent"},
                 {"label": "Never renders", "value": "{ins.best_score.sum}", "note": "a placeholder with no value is skipped"}],
