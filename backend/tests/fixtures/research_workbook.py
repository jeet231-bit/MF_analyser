...
def research_map() -> dict:
    ...
    return {
        ...
        "narratives": {
            ...
            "executive": [{"default": "{rated|fund carries|funds carry} a composite rating this cycle across {ranked_categories} ranked categories, and {q1} of them {q1?sits|sit} in the top quartile."},
                          ...
                          {"default": "{moved|fund|funds} changed rank since {previous}.", "zero": "No fund changed rank since {previous}."}],
            "distribution": [{"default": "Quartiles are computed within each category: {ranked_categories} ranked categories."}],
        ...
        "kpis": [{"label": "Rated funds", "value": "{rated}", "note": "across {ranked_categories} ranked categories", "tone": "q1"},
