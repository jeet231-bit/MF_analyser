    ...
    <div>
      ...
      <div className="grid gap-[18px] md:grid-cols-12">
        <div className="md:col-span-7">
          ...
          <p className="m-0 mt-3 text-xs text-muted">Close the workbook in Excel first, and upload a saved copy rather than the live file.</p>
        </div>
        <RCard className="md:col-span-5" title="What happens next" sub="Nothing goes live until you approve it">
          <ol className="m-0 list-none p-0">
            {STEPS.map(([title, sub], i) => (
              <li key={title} className="flex items-center gap-[11px] border-b border-hairline py-2.5 last:border-b-0">
